var services = [{
	...
	prefix: 'play.google.com/music',
	isPlaying: 'document.getElementById(\'player-bar-play-pause\').className.indexOf(\'playing\')>=0',
	toggle: 'document.getElementById(\'player-bar-play-pause\').click();',
	...
	prefix: '.podomatic.com',
	isPlaying: 'document.getElementsByClassName(\'audio_play\').length > 0 && document.getElementsByClassName(\'audio_play\')[0].className.indexOf(\'pause\')>=0',
	toggle: 'document.getElementsByClassName(\'audio_prev\')[0].click();',
	next: 'document.getElementsByClassName(\'audio_play\')[0].click();',
	prev: 'document.getElementsByClassName(\'audio_next\')[0].click();'
}];
...
function listenForHotKeys() {
	$.ajax({
		...
		chrome.alarms.create(null, {delayInMinutes: 0.1});
		chrome.alarms.onAlarm.addListener(function () {
			console.log("listenForHotKeys restarted");
